...
def_optargs_lsr1 = (:(x0::AbstractVector),)
...
def_kwargs_lsr1 = extract_parameters.(def_kwargs_lsr1)

args_lsr1 = (:A, :b)
optargs_lsr1 = (:x0,)
kwargs_lsr1 = (:M, :N, :ldiv, :radius, :reorthogonalization, :atol, :rtol, :itmax, :timemax, :verbose, :history, :callback, :iostream)
